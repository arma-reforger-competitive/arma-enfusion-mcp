...
Thanks for your interest in contributing! Community contributions are welcome.
...
```bash
git clone https://github.com/arma-reforger-competitive/arma-enfusion-mcp.git
cd arma-enfusion-mcp
npm install
npm run build
npm test
```
...
- **Bug reports** — Include your OS, Node version, and steps to reproduce.
- **Feature requests** — Describe the modding use case it enables.
...
For bugs, the more detail the better — Arma Reforger modding setups vary a lot between users. Include OS, Node version, and reproduction steps.
